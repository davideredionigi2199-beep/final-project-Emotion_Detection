...
def sent_analyzer():
    ...
    # Pass the text to the emotion_detector function from our package
    response = emotion_detector(text_to_analyze)

    # Check for invalid input (e.g., if Watson returns None or an error)
